...
// For Google Maps
let   map, infowindow;
var location_philadelphia = {"lat": 30.284919, "lng": -97.734057};
...
$("body").on("click", "tbody tr", function() {
    ...
    var d = data[$("tbody tr").index(this)];
    var places = {"eat": d.eat, "play": d.play, "drink": d.drink};
    ...
    for (let key in places) {
        ...
        google.maps.event.addListener(marker, "click", function() {
            var output = `<div><strong>${places[key].name}</strong></div>`;
