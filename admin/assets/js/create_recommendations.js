...
var database_eat   = database.ref("events").child("eat");
var database_play  = database.ref("events").child("play");
var database_drink = database.ref("events").child("drink");
var database_recommendations = database.ref("recommendations");
...
var numRecommendations_max = 400, metric_max = 10;

// Possible events
var eventNames_eat   = ["asian"  , "bbq"    , "indian" , "pizza"  , "tex-mex"];
var eventNames_play  = ["bowl"   , "hike"   , "movie"  , "spa"    , "swim"   ];
var eventNames_drink = ["bar"    , "brewery", "coffee" , "tea"    , "wine"   ];

function loadDatabases(eventName_eat, eventName_play, eventName_drink) {
    let   eat, play, drink;
    var directoryName = `${eventName_eat}_${eventName_play}_${eventName_drink}`;
